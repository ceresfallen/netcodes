...
```
code name       : Geek
geekcode base   : 4.0 RFC (TAM)
source url      : https://github.com/telavivmakers/geek_code
source license  : Unlicense
local license   : Not specified. Please use version from source URL if you
                  need a licensed version.
```
This RFC came from [here](https://github.com/telavivmakers/geek_code), which was licensed under the Unlicense. It is considered to form the basis of the updates and derivs I'm working on. The license in this repository is unclear at the present time; as I consolidate things together and get a feel for their licenses, I'll also get this put into place.
